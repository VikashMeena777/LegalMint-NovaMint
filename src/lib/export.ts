    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "Disclaimer: This document was generated by LegalEase AI and does not constitute legal advice. Consult a qualified advocate for legal matters.",
                italics: true,
                size: 18,
                color: "666666",
              }),
...
<body>
  <h1>${title}</h1>
  <div>${htmlContent}</div>
  <div class="disclaimer">Disclaimer: This document was generated by LegalEase AI and does not constitute legal advice. Consult a qualified advocate for legal matters.</div>
</body>
</html>`;
}

export function exportToMarkdown(title: string, content: string): string {
  return `# ${title}\n\n${content}\n\n---\n\n*Disclaimer: This document was generated by LegalEase AI and does not constitute legal advice. Consult a qualified advocate for legal matters.*`;
}
